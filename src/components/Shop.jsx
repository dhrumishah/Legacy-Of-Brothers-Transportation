  ...
  return (
    <>
      <div className="bg-[#F8F8F8]">
        <h1 className="text-center pt-14 font-bold">Online Store</h1>
        <div className="flex flex-col mx-auto pt-14 pb-10 text-sm gap-4 text-center sm:flex-row sm:pb-72 sm:justify-center sm:gap-5 md:text-[0.8rem] lg:text-[0.9rem] xl:text-[0.8rem]">
          <div className="w-1/5 mx-auto">
            <img src={color} alt="" />
            <div className="flex justify-center gap-2 py-2">
              <span
                onClick={() => setColor("/src/assets/yellowT.png")}
                class="w-3 h-3 bg-yellow-300 rounded-full cursor-pointer"
              ></span>
              <span
              ...
              <span
                ...
                class="w-3 h-3 bg-black rounded-full cursor-pointer"
              ></span>
              <span
