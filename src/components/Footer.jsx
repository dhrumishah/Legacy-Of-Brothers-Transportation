  ...
  return (
    <>
      <div className="relative">
        ...
        />
        <div className="flex flex-row-reverse text-[0.55rem] pt-6 gap-5 mr-14 justify-items-end text-white sm:gap-3 sm:text-[0.65rem] md:gap-3 md:text-[0.6rem] lg:gap-4 lg:text-[0.6rem] xl:text-[0.55rem]">
