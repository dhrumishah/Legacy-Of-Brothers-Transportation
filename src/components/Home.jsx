  ...
  return (
    <>
      ...
      <div class="secondcontainer relative">
        ...
        <div class="absolute top-[16%] right-[15%] h-48 text-center bg-[#e1e1e166] text-black rounded-md  flex flex-col justify-evenly px-7 py-3">
      ...
      <div class="thirdcontainer services flex flex-col items-center pt-6 pb-6">
        ...
        <div class="services-type flex flex-col justify-center items-center mx-10 gap-8 md:flex-row md:gap-6 flex-wrap">
          ...
          <Link to="/aboutus">
            <div class="box w-[14rem] p-5 text-center shadow-md md:shadow-xl">
          ...
          <Link to="/aboutus">
            <div class="box w-[14rem] p-1  text-center shadow-md md:shadow-xl">
              <h1 class="text-s font-bold text-[#7B7B7B] mt-2 mb-4">
                Pilot Car
              </h1>
              <p class="mt-4 mb-4 text-[.6rem] leading-3 p-2">
